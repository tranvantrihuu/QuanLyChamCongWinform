...
namespace QuanLyChamCong.API.Models
{
    public class BangLuongChot
    {
        ...
        public long? tong_ca_duoc_phan { get; set; }

        public long? tong_ca_di_lam { get; set; }

        public long? tong_ca_nghi { get; set; }

        public long? tong_phut_di_tre { get; set; }

        public long? tong_phut_ve_som { get; set; }

        public long? tong_phut_bi_tru { get; set; }

        public long? tong_phut_tang_ca { get; set; }
